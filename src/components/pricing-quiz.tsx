...
const QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      /* These map 1:1 to the three services on /services. Nothing here may
         describe something we do not actually build. */
      {
        id: "website",
        icon: Utensils,
        label: "Website + zero-commission ordering",
        blurb: "Live park map, QR express menu, every dollar stays yours",
      },
      {
        id: "social",
        icon: Megaphone,
        label: "Social media marketing",
        blurb: "Google profile, daily posts, local TikTok and Meta ads",
      },
      {
        id: "ai",
        icon: MessageSquare,
        label: "AI automation",
        blurb: "Text it your spot, it updates the site and posts for you",
      },
      {
        id: "full",
        icon: LayoutGrid,
        label: "All three",
        blurb: "Site, socials, and AI, phased so it pays as it goes",
      },
      {
        id: "unsure",
        icon: HelpCircle,
